...
function textColor($color_name) {
	$colors = array(
		...
		'grey' => '555',
		'lightgrey' => '9f9f9f',
		//custom colours, bilibili
		'bilibili_pink' => "f25d8e",
		'bilibili_yellow' => 'f29144',
		'bilibili_blue' => '00a1d6',
		'bilibili_green' => '2eca7f',
		'bilibili_red' => '',
		//custom colours, netease
		'netease_red' => 'c20c0c',
		//custom colours, zhihu
		'zhihu_blue' => '086dd4'
	);
...
***/
function drawBadge($subject, $status, $color) {
